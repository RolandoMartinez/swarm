...
float searchVelocity = 0.3; // meters/second original is 0.2 - Abe
...
int main(int argc, char **argv) {
    ...
    //select initial search position 50 cm from center (0,0) // changed to 0.4 for both - Abe
    goalLocation.x = 0.4 * cos(goalLocation.theta+M_PI);
    goalLocation.y = 0.4 * sin(goalLocation.theta+M_PI);
